<?php
    ...
    class CoinCombinatorTest extends PHPUnit_Framework_TestCase
    {
        ...
        function test_countCoins_oneQuarterOneDime()
        {
            //Arrange
            $test_CoinCombinator = new CoinCombinator;
            $cents = 35;
        ...
        function test_countCoins_oneQuarterOneDimeOneNickel()
        {
            //Arrange
            $test_CoinCombinator = new CoinCombinator;
            $cents = 40;
        ...
        function test_countCoins_oneQuarterOneDimeOneNickelOnePenny()
        {
            //Arrange
            $test_CoinCombinator = new CoinCombinator;
            $cents = 41;
